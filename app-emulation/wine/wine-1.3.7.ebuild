...
LICENSE="LGPL-2.1"
SLOT="0"
IUSE="alsa capi +corefonts cups custom-cflags dbus elibc_glibc fontconfig +gecko gnutls gphoto2 gsm gstreamer jack jpeg lcms ldap mp3 nas ncurses openal +opengl +oss +perl png +prelink samba scanner ssl test +threads +truetype v4l +win32 +win64 +X xcomposite xinerama xml"
