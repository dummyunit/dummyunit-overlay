...
LICENSE="LGPL-2.1"
SLOT="0"
IUSE="alsa cups dbus esd +gecko gnutls hal jack jpeg lcms ldap nas ncurses
+opengl oss png samba scanner ssl win64 +X xcomposite xinerama xml nos3tc"
RESTRICT="test" #72375
...
src_prepare() {
	...
	use nos3tc && epatch "${FILESDIR}"/${P}-disable-s3tc.patch
