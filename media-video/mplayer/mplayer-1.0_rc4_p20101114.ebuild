...
# $Header: /var/cvsroot/gentoo-x86/media-video/mplayer/mplayer-1.0_rc4_p20101114.ebuild,v 1.9 2011/07/08 10:10:07 ssuominen Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}/${P}-fix-libvorbis-linking.patch" || die
	base_src_prepare
}
